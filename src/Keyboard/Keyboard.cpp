...
cpp3ds::String Keyboard::getCurrentInput() const
{
	return m_input.text.getString();
}


void Keyboard::setCurrentInput(const cpp3ds::String &input)
{
	m_input.text.setString(input);
	m_input.data = input;
}
